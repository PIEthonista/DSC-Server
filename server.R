...
shinyServer(function(input, output, session) {
  ...
  output$yixian <- renderText({c('<img src="',yixian,'" width="100" height="150">')})
  congji <- "https://github.com/PIEthonista/DSC-Server/raw/main/www/congji.jpg"
  output$congji <- renderText({c('<img src="',congji,'" width="100" height="150">')})
  yiqing <- "https://github.com/PIEthonista/DSC-Server/raw/main/www/huoyiqing.jpg"
  output$yiqing <- renderText({c('<img src="',yiqing,'" width="100" height="150">')})
  bingbing <- "https://github.com/PIEthonista/DSC-Server/raw/main/www/bingbing.jpg"
  output$bingbing <- renderText({c('<img src="',bingbing,'" width="100" height="150">')})
